...
def talker():
  ...
  map_update_msg.info.resolution = 0.05
  
  map_update_msg.info.origin.position.x = 1.0
  map_update_msg.info.origin.position.y = 1.0
  ...
  map_update_msg.info.width = 40
  map_update_msg.info.height = 40

  temp_array = [-1] * map_update_msg.info.width * map_update_msg.info.height
