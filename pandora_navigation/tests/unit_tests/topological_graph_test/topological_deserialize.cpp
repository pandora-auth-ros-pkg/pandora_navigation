...
void saveVoronodes(const VoronoiNodes &s, const char * filename){
    // make an archive
...
void
restoreVoronodes(VoronoiNodes &s, const char * filename)
{
    // open the archive
...
int main(){
	...
	restoreVoronodes(voronoiNodes,"voronodes_marshall");
