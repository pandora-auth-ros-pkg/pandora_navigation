...
int main(){
	...
	PartitionGraphPathGenerator partitionGraphPathGenerator(&mapAtt,&voronoi);
	
	partitionGraphPathGenerator.generatePath( poseStampedGoal, plan) ;
	...
	drawGraph(mapSmall.display,partitionGraphPathGenerator.partitionNodes.nodes,prevxMin,prevxMax,prevyMin,prevyMax);
